...
class AccessControlSeeder extends Seeder
{
    ...
    {
        $permissions = collect(['directory.read', 'directory.write', 'directory.verify', 'directory.transfer', 'sources.manage', 'imports.manage', 'audit.read'])
        ...
        foreach (['super_admin', 'tec_admin', 'diocesan_admin', 'deanery_admin', 'parish_admin'] as $name) {
            ...
            $allowed = in_array($name, ['super_admin', 'tec_admin'], true)
                ? $permissions->values()
                : $permissions->only(['directory.read', 'directory.write', 'directory.verify', 'directory.transfer'])->values();
